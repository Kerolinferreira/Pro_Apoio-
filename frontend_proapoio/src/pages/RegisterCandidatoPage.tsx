            ...
            <div className="card-auth-large">
                ...
                >
                    ...
                    <fieldset className="fieldset-group">
                        ...
                        {/* Seleção de deficiências com experiência */}
                        {deficiencias.length > 0 && (
                            <div className="form-group mt-md">
                                <label className="form-label">Deficiências com experiência (opcional)</label>
                                <p className="text-xs text-muted mb-sm">Selecione as deficiências com as quais você já possui experiência de trabalho:</p>
